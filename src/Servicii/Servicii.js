...
const Servicii = () => {
	return(
		...
		<li>Curatarea si hidratarea suprafetelor din piele si vinil pentru aspect placut si protectie de durata </li>
		<li>Curatare guri de ventilatie, sine scaune, spatiu de depozitare roata de rezerva </li>
		...
		<li>Polisarea/lustruirea lacului </li>
		<li>Curatarea jantelor, anvelopelor si protejarea lor</li>
		<li>Polisarea elementelor cromate precum si a ornamentului evacuarii finale</li>
		<li>Polisarea farurilor </li>
		</div>
		</div>
